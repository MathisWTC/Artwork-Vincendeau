...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { date: @artwork.date, description: @artwork.description, dimension: @artwork.dimension, image: @artwork.image, title: @artwork.title } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { date: @artwork.date, description: @artwork.description, dimension: @artwork.dimension, image: @artwork.image, title: @artwork.title } }
